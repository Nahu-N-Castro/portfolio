  ...
  return (
    <section className="absolute top-0 right-0 md:left-auto md:right-0 w-full md:w-2/3 h-full md:py-16 md:px-5 text-black z-20">
      ...
      <div className="bg-amber-50 p-5  max-h-[85%] sm:max-h-[95%] overflow-y-auto">
        ...
        {content ? (
          <div className="bg-amber-200 p-5">{projects[title].overview}</div>
        ) : (
          <div className="bg-amber-200 p-5">{projects[title].detail}</div>
        )}
      </div>
    </section>
  );
