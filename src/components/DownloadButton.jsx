...
const DownloadButton = ({ onSelect }) => {
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-[90vw] sm:w-[40vw] dark:bg-neutral-900 rounded-lg shadow-neutral-900 bg-purple-600 dark:bg-opacity-90 dark:text-white  dark:backdrop-blur-3xl shadow-lg z-10  ">
      <WindowHeader onSelect={onSelect} title={"Curriculum Vitae"} />
      <p className="mt-4 text-lg text-black dark:text-white">
        ¿Descargar o Ver mi CV?
      </p>
